...
class StringManipulationInstruction extends InstructionBase
{
    // PROPERTIES
    ...
    {
        $visitor->visitStringManipulationInstruction($this);
    }
}